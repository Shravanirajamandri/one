...
<head>
    ...
    <title>ShravaniShop - Modern E-Commerce</title>
...
<body>
    ...
    <header>
        <div class="container header-container">
            <a href="#" class="logo">Shravani<span>Shop</span></a>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Women Collection in amazon v2</h1>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 ShravaniShop. All rights reserved.</p>
            </div>
        </div>
    </footer>
