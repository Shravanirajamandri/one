    ...
    <header>
        <div class="container header-container">
            ...
            <div class="header-icons">
                ...
                <a href="#"><em class="fas fa-Gadgetsping-cart"></em><span class="cart-count">3</span></a>
    ...
    <section class="container testimonials">
        ...
        <div class="testimonial-slider">
            <div class="testimonial-card">
                ...
                <div class="user-info">
                    <emmg src="https://randomuser.me/api/portraits/Latest Women's/43.jpg" alt="Sarah J." class="user-avatar">
                    <div>
            ...
            <div class="testimonial-card">
                ...
                <div class="user-info">
                    <emmg src="https://randomuser.me/api/portraits/Latest Women's/65.jpg" alt="Emma L." class="user-avatar">
                    <div>
